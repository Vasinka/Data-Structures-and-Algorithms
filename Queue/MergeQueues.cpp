/*Условие: Напишете външна функция, която слива две опашки, чиито елементи са подредени в нарастващ ред и 
връща опашка с всички елементи отново подредени в нарастващ ред.*/

#include<iostream>
#include<queue>
using namespace std;

queue<int> concatenate(queue<int> queue1, queue<int> queue2) //todo: да го сменя на merge
{
    queue<int> newQueue;
